...
g_config.editor := {  	1 : A_ProgramFiles "\Microsoft VS Code\Code.exe", 	2 : "C:\Program Files\Microsoft VS Code\Code.exe", 	3 : "C:\Program Files\Microsoft VS Code\bin\code.cmd", 	4 : "C:\Users\lauffer\AppData\Local\Programs\Microsoft VS Code\Code.exe", 	5 : "G:\fre\git\github\global-IntelliSense-everywhere-Nightly-Build\Source" "\..\AHK-Studio\AHK-Studio.ahk", 	6 : "C:\Program Files\Notepad++\notepad++.exe", 	7 : "G:\fre\git\github\global-IntelliSense-everywhere-Nightly-Build\Source" "\..\AutoGUI\AutoGUI.ahk" } ; above the list of the editors, which is gone through alphabetically up to the first find (fileAdress exists). 
...
g_config.listBoxGui := {  	tipps: {  		show: true, 		durationMilliseconds: 3000 	} } 
...
g_config.codeRunner.executorMap := {         javascript: "node",         php: "C:\php\php.exe",         python: "python",         perl: "perl",         ruby: "C:\Ruby23-x64\bin\ruby.exe",         go: "go run",         html: "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe",         java: "cd $dir && javac $fileName && java $fileNameWithoutExt",         c: "cd $dir && gcc $fileName -o $fileNameWithoutExt && $dir$fileNameWithoutExt", 		kotlinc: "G:\fre\git\github\global-IntelliSense-everywhere-Nightly-Build\Source" "\..\ActionLists\_kts\kotlinc\bin\kotlinc"     } 
