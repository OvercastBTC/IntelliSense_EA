...
; dontDeleteThisPlaceholder (getAhkCodeInsideFile~1124~createActionListAddress.inc.ahk)
#Include .\..\actionLists\OpusApp\..\ActionListNameFilter.inc.ahk ; global ActionList . pleas dont delete this line! 17-03-06_10-59
ActionListFilterPath = .\..\actionLists\OpusApp\ActionListNameFilter.inc.ahk
 ; (line:%A_LineNumber%) 
...
if (!actionListNEW ){
 ...
 g_lineNumberFeedback=1126~G:\fre\git\github\global-IntelliSense-everywhere-Nightly-Build\Source\inc_ahk\createActionListAddress.inc.ahk~getAhkCodeInsideFile
...
; Clipboard := actionListNEW `n G:\fre\git\github\global-IntelliSense-everywhere-Nightly-Build\Source\inc_ahk\createActionListAddress.inc.ahk~getAhkCodeInsideFile~1126 `n we dont need that anymore. becouse now we work without the clipboard 09.03.2017 21:21 isInternMsgTransportIsClipboard := false ; false. then using fileSystem: readfile, include copyfile
