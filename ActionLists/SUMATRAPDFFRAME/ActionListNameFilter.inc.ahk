...
; dontDeleteThisPlaceholder (getAhkCodeInsideFile~1178~Typing_Aid_everywhere_multi_clone.inc.ahk)
#Include .\..\ActionLists\SUMATRAPDFFRAME\..\ActionListNameFilter.inc.ahk ; global ActionList . pleas dont delete this line! 17-03-06_10-59
ActionListFilterPath = .\..\ActionLists\SUMATRAPDFFRAME\ActionListNameFilter.inc.ahk 
 ; (line:%A_LineNumber%) 
...
if (!ActionListNEW ){
 ...
 g_lineNumberFeedback=1180~G:\fre\git\github\global-IntelliSense-everywhere-Nightly-Build\Source\inc_ahk\Typing_Aid_everywhere_multi_clone.inc.ahk~getAhkCodeInsideFile
